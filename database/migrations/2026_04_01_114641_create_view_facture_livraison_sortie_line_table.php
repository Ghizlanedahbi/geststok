...
return new class extends Migration
{
    ...
    {
        Schema::create('view_facture_livraison_sortie_line', function (Blueprint $table) {
            $table->string('OperationType', 1);
    ...
    {
        Schema::dropIfExists('view_facture_livraison_sortie_line');
    }
};
