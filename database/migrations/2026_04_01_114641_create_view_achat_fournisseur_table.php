...
return new class extends Migration
{
    ...
    {
        Schema::create('view_achat_fournisseur', function (Blueprint $table) {
            ...
            $table->integer('FOURNISSEUR_CATEGORIE_ID')->nullable();
            ...
            $table->string('FOURNISSEUR_CATEGORIE_LIBELE', 1)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('view_achat_fournisseur');
    }
};
