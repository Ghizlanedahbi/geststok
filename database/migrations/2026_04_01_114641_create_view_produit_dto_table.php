...
return new class extends Migration
{
    ...
    {
        Schema::create('view_produit_dto', function (Blueprint $table) {
            $table->integer('PRODUIT_ID');
            $table->string('BAR_CODE', 1)->nullable();
            ...
            $table->boolean('is_materials')->nullable();
    ...
    {
        Schema::dropIfExists('view_produit_dto');
    }
};
