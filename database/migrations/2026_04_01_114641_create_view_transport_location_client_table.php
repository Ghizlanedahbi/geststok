...
return new class extends Migration
{
    ...
    {
        Schema::create('view_transport_location_client', function (Blueprint $table) {
            $table->integer('TYPE');
            $table->integer('ID');
            ...
            $table->string('Conducteur1', 1)->nullable();
            $table->string('Conducteur2', 1)->nullable();
            $table->integer('CONDUCTEUR1_ID')->nullable();
            $table->integer('CONDUCTEUR2_ID')->nullable();
            ...
            $table->decimal('POID', 12, 4)->nullable();
    ...
    {
        Schema::dropIfExists('view_transport_location_client');
    }
};
